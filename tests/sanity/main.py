...
def run_sanity_check(test_dir):
    ...
    if not test_functions_for_post:
        ...
        print(FAIL_COLOR + 'Please make sure you have TWO test cases for the POST() method.One test case for EACH of the possible inferences (results/outputs) of the ML model.\n')
        SANITY_TEST_PASSING = False
    else:
